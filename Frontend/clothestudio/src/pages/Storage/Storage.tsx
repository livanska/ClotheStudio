...
export const Storage = () => {
    ...
    useEffect(() => {
        const res1 = axios.get(`http://localhost:3000/api/StoredMaterials`).then(r => setStored(r.data.filter((st :any)=>st.atelieID ==(JSON.parse(localStorage.getItem('user')!)).atelieID )))
        console.log(res1)
    }, [])
